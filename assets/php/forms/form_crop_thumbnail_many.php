<form id="form-crop-thumbnail-many" class="container bg-light p-3">
    <div class="my-3">
    ...
    <div class="my-3">
        <input id="do-crop-thumbnail-many" type="button" class="btn btn-sm btn-primary w-100" value="Crop & Thumbnail" />
    </div>
</form>
